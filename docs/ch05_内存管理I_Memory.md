...
<div><strong>← 上一章</strong><br><a href="ch04_异常与断言_Exceptions.html">第4章 异常与断言</a></div>
<div><strong><a href="index.html">📖 返回目录</a></strong></div>
<div style="text-align:right"><strong>下一章 →</strong><br><a href="ch06_内存管理II_Arena.html">第6章 内存管理 II Arena</a></div>
</div>
